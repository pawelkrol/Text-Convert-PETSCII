...
Updating version number and release date of the Text::Convert::PETSCII package:
...
$command = sprintf q{sed -i -e "s/Text::Convert::PETSCII Version [0-9]\\+\\.[0-9]\\+/Text::Convert::PETSCII Version %s/" README}, $new_version;
